...
A versatile modal wrapper built on top of `HcModal`. It provides standard slots for Title, Content, and Footer, while exposing a simple API for programmatic control.
