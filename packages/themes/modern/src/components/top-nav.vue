    ...
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-[1920px]">
      ...
      <a href="/" target="_blank" class="flex items-center gap-4 group">
        ...
        <div class="flex flex-col">
            ...
            <span class="text-[9px] font-black text-blue-500 uppercase tracking-widest mt-1">Management Console</span>
        </div>
      </a>
      ...
      <div class="hidden md:flex items-center gap-10">
          ...
          <div class="flex items-center gap-6 border-l border-gray-100 pl-10">
            <div class="flex flex-col items-end">
                <span class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] leading-none mb-1">Session Active</span>
